...
pub mod ops {
    ...
    impl BlendedNoise {
        ...
        fn new(
            ...
            Self {
                ...
                main_noise: PerlinNoise::create_for_blended_noise(
                    rng,
                    &(-7..=0).collect::<Vec<_>>(),
                ),
                xz_scale,
    ...
    impl Noise3d for BlendedNoise {
        fn get(&self, pos: glam::DVec3) -> f64 {
            ...
            let scaled_pos =
                multiplied_pos / DVec3::new(self.xz_factor, self.y_factor, self.xz_factor);
    ...
    mod java_tests {
        ...
        use crate::{
            density_function::ops::BlendedNoise,
    ...
    mod tests {
        ...
        use crate::{
            density_function::{
                FunctionOp,
                ops::{BlendedNoise, FlatCache, Interpolated},
            },
